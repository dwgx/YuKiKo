...
CONFIG_SCHEMA: dict[str, tuple[tuple[type, ...], bool]] = {
    ...
    'memory.reflection_enable': ((bool,), False),
    'memory.reflection_interval_messages': ((int,), False),
    'memory.reflection_interval_minutes': ((int,), False),
    'memory.reflection_model': ((str,), False),
    'memory.reflection_max_tokens': ((int,), False),
